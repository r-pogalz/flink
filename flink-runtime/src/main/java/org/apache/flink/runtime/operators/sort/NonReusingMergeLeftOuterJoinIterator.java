...
public class NonReusingMergeLeftOuterJoinIterator<T1, T2, O> extends AbstractMergeLeftOuterJoinIterator<T1, T2, O> {

	public NonReusingMergeLeftOuterJoinIterator(
