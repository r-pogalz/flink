...
public class ReusingSortMergeOuterJoinIteratorITCase {
	...
	private List<Tuple4<String, String, String, Object>> computeOuterJoin(ResettableMutableObjectIterator<Tuple2<String, String>> input1,
		...
		input1.reset();
		input2.reset();
		ReusingMergeOuterJoinIterator<Tuple2<String, String>, Tuple2<String, Integer>, Tuple4<String, String, String, Object>> iterator =
				new ReusingMergeOuterJoinIterator<Tuple2<String, String>, Tuple2<String, Integer>, Tuple4<String, String, String, Object>>(
	...
	public void testOuterJoinWithHighNumberOfCommonKeys(OuterJoinType outerJoinType, int input1Size, int input1Duplicates, int input1ValueLength,
		...
		try {
			final Generator generator1 = new Generator(SEED1, 500, input1KeyDensity, input1ValueLength, KeyMode.SORTED_SPARSE, ValueMode.RANDOM_LENGTH, null);
			final Generator generator2 = new Generator(SEED2, 500, input2KeyDensity, input2ValueLength, KeyMode.SORTED_SPARSE, ValueMode.RANDOM_LENGTH, null);
			...
			ReusingMergeOuterJoinIterator<Record, Record, Record> iterator =
					new ReusingMergeOuterJoinIterator<Record, Record, Record>(
							outerJoinType, input1, input2, serializer1, comparator1, serializer2, comparator2,
